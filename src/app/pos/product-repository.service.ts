...
const LOCAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Six coordinated red, white, and blue cakesicles, boxed and ready to share.',
    priceInCents: 3000,
    imageUrl: 'assets/treats/patriotic-cakesicles.jpg',
    imageAlt: 'Tray of six red, white, and blue decorated cakesicles',
    category: 'Party packs',
  },
  {
    id: 6,
    title: 'Custom Detail Party Pack',
    description: 'Six hand-detailed cakesicles designed around your colors and occasion.',
    priceInCents: 3300,
    imageUrl: 'assets/treats/usa-cakesicles-closeup.jpg',
    imageAlt: 'Close-up of cakesicles with detailed stars and stripes decoration',
    category: 'Party packs',
  },
];
